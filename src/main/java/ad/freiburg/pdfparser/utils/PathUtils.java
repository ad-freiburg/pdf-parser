...
/**
 * A collection of some common useful methods dealing with paths.
 * 
 * @author Claudius Korzen
 */
public class PathUtils {
  /**
   * Returns the basename of the given file, that is: the filename without the file extension.
   * 
  ...
  /**
   * Reads the given directory non-recursively and returns a map with the names and the streams of
   * all files in this directory. Works also in jar files.
   * 
